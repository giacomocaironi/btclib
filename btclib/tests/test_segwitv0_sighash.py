...
def test_native_p2wpkh():
    ...
    previous_txout = TxOut(
        nValue=600000000,
        scriptPubKey=Script("00141d0f172a0ecb48aee1be1f2687d2963ae33f71a1"),
    )
...
def test_wrapped_p2wpkh():
    ...
    previous_txout = TxOut(
        nValue=1000000000,
        scriptPubKey=Script("a9144733f37cf4db86fbc2efed2500b4f4e49f31202387"),
    )
...
def test_native_p2wsh():
    ...
    script_code = _get_witness_v0_scriptCodes(
        Script(transaction.vin[1].txinwitness[-1])
    )[1]
